...
Generated from `claude/skills/resolve-conflicts/SKILL.md` by `bin/sync-codex-from-claude`.
...
3. **Determine if the changes are:**
   ...
   - **Complementary**: Both needed but require manual merging
...
- **NEVER BLINDLY CHOOSE** — always understand both sides
...
# 4. View each side's full version
